...
exports.default = {
    getEndpointOrgan(endpointNodeId) {
        ...
        const organs = this.findParents(endpointNodeId, [spinal_model_bmsnetwork_1.SpinalBmsNetwork.relationName, spinal_model_bmsnetwork_1.SpinalBmsDevice.relationName, spinal_model_bmsnetwork_1.SpinalBmsEndpoint.relationName, spinal_model_bmsnetwork_1.SpinalBmsEndpointGroup.relationName], (node => {
    ...
    getDevices(endpointNodeId) {
        ...
        const devices = this.findParents(endpointNodeId, [spinal_model_bmsnetwork_1.SpinalBmsDevice.relationName, spinal_model_bmsnetwork_1.SpinalBmsEndpoint.relationName, spinal_model_bmsnetwork_1.SpinalBmsEndpointGroup.relationName], (node => {
